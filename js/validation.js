...
document.addEventListener("DOMContentLoaded", () => {
    const botonMiembro = document.getElementById("boton-registrar-miembro");
    const botonActividad = document.getElementById("boton-registrar-actividad");
    if (botonMiembro) {
        botonMiembro.addEventListener("click", validarMiembros);
    }
    if (botonActividad) {
        botonActividad.addEventListener("click", validarActividades);
    }
});
